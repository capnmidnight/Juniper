...
import { dispose, using, usingArray, usingArrayAsync, usingAsync } from "@juniper-lib/tslib/dist/using";
...
export class UsingTests extends TestCase {
    ...
    test_DisposeUndefined() {
        this.doesNotThrow(() => dispose(undefined));
    }
    test_DisposeString() {
    ...
    test_UsingUndefined() {
        this.doesNotThrow(() => using(undefined, this.isUndefined.bind(this)));
    }
    ...
    test_UsingAsyncUndefined() {
        this.doesNotThrow(() => usingAsync(undefined, async (obj) => this.isUndefined(obj)));
    }
    ...
    test_UsingArrayUndefined() {
        this.doesNotThrow(() => usingArray(undefined, this.isUndefined.bind(this)));
    }
    test_UsingArrayOfUndefineds() {
        this.doesNotThrow(() => usingArray([undefined, undefined, undefined], (arr) => arr.forEach((obj) => this.isUndefined(obj))));
    }
    ...
    test_UsingArrayAsyncUndefined() {
        this.doesNotThrow(() => usingArrayAsync(undefined, async (arr) => this.isUndefined(arr)));
    }
    test_UsingArrayAsyncOfUndefineds() {
        this.doesNotThrow(() => usingArrayAsync([undefined, undefined, undefined], async (arr) => arr.forEach((obj) => this.isUndefined(obj))));
    }
}
