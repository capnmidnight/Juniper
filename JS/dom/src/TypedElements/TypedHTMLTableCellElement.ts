...
export abstract class TypedHTMLTableCellElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLTableCellElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
