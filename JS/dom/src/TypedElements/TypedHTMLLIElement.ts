...
export abstract class TypedHTMLLIElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLLIElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
