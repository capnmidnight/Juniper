...
export abstract class TypedHTMLOListElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLOListElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
