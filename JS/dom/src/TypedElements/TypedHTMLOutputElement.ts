...
export abstract class TypedHTMLOutputElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLOutputElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
