...
export abstract class TypedHTMLMenuElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLMenuElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
