...
export abstract class TypedHTMLMetaElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLMetaElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
