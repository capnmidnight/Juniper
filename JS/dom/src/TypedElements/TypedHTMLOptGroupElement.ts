...
export abstract class TypedHTMLOptGroupElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLOptGroupElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
