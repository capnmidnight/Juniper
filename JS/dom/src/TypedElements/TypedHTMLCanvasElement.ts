...
export abstract class TypedHTMLCanvasElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLCanvasElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
