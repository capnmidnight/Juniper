...
export abstract class TypedHTMLTrackElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLTrackElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
