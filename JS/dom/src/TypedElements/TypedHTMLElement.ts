...
export abstract class TypedHTMLElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
