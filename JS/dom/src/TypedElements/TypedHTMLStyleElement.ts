...
export abstract class TypedHTMLStyleElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLStyleElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
