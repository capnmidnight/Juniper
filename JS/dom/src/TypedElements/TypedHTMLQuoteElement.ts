...
export abstract class TypedHTMLQuoteElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLQuoteElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
