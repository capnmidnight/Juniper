...
export abstract class TypedHTMLTextAreaElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLTextAreaElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
