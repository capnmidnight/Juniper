...
export abstract class TypedHTMLAnchorElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLAnchorElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
