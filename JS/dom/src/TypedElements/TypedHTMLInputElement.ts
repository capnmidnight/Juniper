...
export abstract class TypedHTMLInputElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLInputElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
