...
export abstract class TypedHTMLHtmlElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLHtmlElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
