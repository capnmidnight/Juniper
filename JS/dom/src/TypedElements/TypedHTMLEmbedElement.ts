...
export abstract class TypedHTMLEmbedElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLEmbedElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
