...
export abstract class TypedHTMLBaseElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLBaseElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
