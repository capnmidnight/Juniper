...
export abstract class TypedHTMLLegendElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLLegendElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
