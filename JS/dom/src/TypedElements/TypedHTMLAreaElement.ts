...
export abstract class TypedHTMLAreaElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLAreaElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
