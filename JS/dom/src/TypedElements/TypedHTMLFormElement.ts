...
export abstract class TypedHTMLFormElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLFormElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
