...
export abstract class TypedHTMLDataListElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLDataListElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
