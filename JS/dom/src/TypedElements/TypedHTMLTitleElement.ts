...
export abstract class TypedHTMLTitleElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLTitleElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
