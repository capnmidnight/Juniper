...
export abstract class TypedHTMLSourceElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLSourceElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
