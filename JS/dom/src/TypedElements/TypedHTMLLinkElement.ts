...
export abstract class TypedHTMLLinkElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLLinkElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
