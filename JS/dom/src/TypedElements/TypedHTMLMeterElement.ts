...
export abstract class TypedHTMLMeterElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLMeterElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
