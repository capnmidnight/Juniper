...
export abstract class TypedHTMLLabelElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLLabelElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
