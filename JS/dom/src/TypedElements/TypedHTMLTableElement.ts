...
export abstract class TypedHTMLTableElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLTableElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
