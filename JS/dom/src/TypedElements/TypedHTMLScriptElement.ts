...
export abstract class TypedHTMLScriptElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLScriptElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
