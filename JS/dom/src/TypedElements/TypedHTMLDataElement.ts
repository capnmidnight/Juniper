...
export abstract class TypedHTMLDataElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLDataElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
