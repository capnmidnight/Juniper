...
export abstract class TypedHTMLBRElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLBRElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
