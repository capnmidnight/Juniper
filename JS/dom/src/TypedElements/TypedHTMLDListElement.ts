...
export abstract class TypedHTMLDListElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLDListElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
