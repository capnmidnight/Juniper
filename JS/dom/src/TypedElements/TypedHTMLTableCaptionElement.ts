...
export abstract class TypedHTMLTableCaptionElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLTableCaptionElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
