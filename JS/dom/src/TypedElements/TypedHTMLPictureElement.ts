...
export abstract class TypedHTMLPictureElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLPictureElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
