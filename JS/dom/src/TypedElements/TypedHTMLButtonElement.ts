...
export abstract class TypedHTMLButtonElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLButtonElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
