...
export abstract class TypedHTMLHeadingElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLHeadingElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
