...
export abstract class TypedHTMLTemplateElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLTemplateElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
