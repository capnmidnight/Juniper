...
export abstract class TypedHTMLOptionElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLOptionElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
