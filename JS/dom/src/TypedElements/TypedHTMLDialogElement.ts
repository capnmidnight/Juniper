...
export abstract class TypedHTMLDialogElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLDialogElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
