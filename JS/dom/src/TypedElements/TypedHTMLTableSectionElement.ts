...
export abstract class TypedHTMLTableSectionElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLTableSectionElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
