...
export abstract class TypedHTMLHRElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLHRElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
