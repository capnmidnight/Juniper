...
export abstract class TypedHTMLHeadElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLHeadElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
