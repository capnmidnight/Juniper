...
export abstract class TypedHTMLDivElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLDivElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
