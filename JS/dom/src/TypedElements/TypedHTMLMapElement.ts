...
export abstract class TypedHTMLMapElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLMapElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
