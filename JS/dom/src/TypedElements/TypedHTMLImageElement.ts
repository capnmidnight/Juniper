...
export abstract class TypedHTMLImageElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLImageElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
