...
export abstract class TypedHTMLUListElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLUListElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
