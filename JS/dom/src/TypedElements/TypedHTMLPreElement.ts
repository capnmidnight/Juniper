...
export abstract class TypedHTMLPreElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLPreElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
