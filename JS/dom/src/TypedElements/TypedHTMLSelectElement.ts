...
export abstract class TypedHTMLSelectElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLSelectElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
