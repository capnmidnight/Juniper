...
export abstract class TypedHTMLFieldSetElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLFieldSetElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
