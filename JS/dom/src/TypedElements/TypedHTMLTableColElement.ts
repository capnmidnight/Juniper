...
export abstract class TypedHTMLTableColElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLTableColElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
