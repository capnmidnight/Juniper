...
export abstract class TypedHTMLProgressElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLProgressElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
