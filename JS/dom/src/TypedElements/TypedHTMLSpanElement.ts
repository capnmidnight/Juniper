...
export abstract class TypedHTMLSpanElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLSpanElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
