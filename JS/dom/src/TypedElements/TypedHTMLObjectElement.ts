...
export abstract class TypedHTMLObjectElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLObjectElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
