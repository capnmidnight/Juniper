...
export abstract class TypedHTMLTimeElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLTimeElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
