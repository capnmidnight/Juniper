...
export abstract class TypedHTMLTableRowElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLTableRowElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
