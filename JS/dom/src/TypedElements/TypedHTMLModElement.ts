...
export abstract class TypedHTMLModElement<EventMapT extends TypedEventMap<string> = TypedEventMap<string>> extends HTMLModElement implements ITypedEventTarget<EventMapT & HTMLElementEventMap> {
