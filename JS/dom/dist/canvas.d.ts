...
export declare function hasHTMLCanvas(): boolean;
export declare function hasHTMLImage(): boolean;
export declare function hasOffscreenCanvas(): boolean;
export declare function hasImageBitmap(): boolean;
...
export declare function hasOffscreenCanvasRenderingContext2D(): boolean;
...
export declare function hasOffscreenCanvasRenderingContext3D(): boolean;
...
export declare function addCanvasResizer(canvas: HTMLCanvasElement): void;
