...
import { alignItems, border, Button, ClassList, Clear, columnGap, display, ElementChild, elementSetDisplay, em, flexBasis, flexDirection, HtmlRender, HtmlTag, I, justifyContent, Name, registerFactory, rule, SingletonStyleBlob, SlotTag, TemplateInstance, TitleAttr, TypedHTMLElement, width } from "@juniper-lib/dom";
...
export class HiddenEditorElement extends TypedHTMLElement<HiddenEditorEventMap> {
    ...
    readonly #opened = new OpenedEvent<HiddenEditorElement>();
    readonly #cancelled = new CancelledEvent<HiddenEditorElement>();
    readonly #updated = new UpdatedEvent<HiddenEditorElement>();
    readonly #delete = new DeleteEvent<HiddenEditorElement>();

    #defaultBlock: HTMLElement = null;
    #editorBlock: HTMLElement = null;
    #openButtonsBlock: HTMLElement = null;
    #closedButtonsBlock: HTMLElement = null;
    #editorButtonsBlock: HTMLElement = null;
    ...
    constructor() {
        ...
        SingletonStyleBlob("Juniper::Widgets::HiddenEditorElement", () =>
            rule("hidden-editor",
                display("flex"),
                flexDirection("row"),
                columnGap(em(.25)),
        ...
        this.#template = TemplateInstance("Juniper::Widgets::HiddenEditorElement", () => [
            ...
            SlotTag(Name("editor")),
            HtmlTag("button-group",
                SlotTag(Name("open-buttons")),
                SlotTag(Name("closed-buttons")),
                Button(
    ...
    #render() {
        if (this.#saveButton) {
            ...
            if (open) {
                HtmlRender(
                    this.#editorButtonsBlock,
                    Clear(),
                    this.#openButtonsBlock,
                    this.#deleteButton,
                    this.#saveButton,
                    this.#cancelButton
                );
...
export function HiddenEditor(...rest: ElementChild<HiddenEditorElement>[]) {
