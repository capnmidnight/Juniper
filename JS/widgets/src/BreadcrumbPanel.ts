...
import { A, ClassName, Clear, display, ElementChild, flexDirection, flexGrow, H2, HtmlRender, HtmlTag, Name, rule, SlotTag, StyleBlob, Template } from "@juniper-lib/dom";


export function BreadcrumbPanel(...rest: ElementChild[]): BreadcrumbPanelElement {
    return HtmlTag("breadcrumb-panel", ...rest);
}
...
export class BreadcrumbPanelElement extends HTMLElement {
    ...
    constructor() {
        ...
        const breadcrumbPanelTemplate = singleton("Juniper:Widgets:BreadcrumbPanel", () => {
        ...
        this.#template = breadcrumbPanelTemplate.content.cloneNode(true) as DocumentFragment;
...
customElements.define("breadcrumb-panel", BreadcrumbPanelElement);