import { Div, ElementChild, HtmlTag, ImportDOM } from "@juniper-lib/dom";

export function AsyncDocFragment(...rest: ElementChild[]): AsyncDocFragmentElement {
    return HtmlTag("async-doc-fragment", ...rest);
}
...
customElements.define("async-doc-fragment", AsyncDocFragmentElement);