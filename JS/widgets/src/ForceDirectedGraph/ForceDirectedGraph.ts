import { arrayClear, compareBy, singleton } from "@juniper-lib/util";
import { StyleBlob, height, overflow, pointerEvents, position, rule, userSelect, width, zIndex } from "@juniper-lib/dom";
...
export class ForceDirectedGraph<T> {
    ...
    constructor(
        ...
        singleton("Juniper:Widgets:ForceDirectedGraph", () => {
