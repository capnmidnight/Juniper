import { EventReplacer, debounce, eventHandler, replaceEventHandler } from "@juniper-lib/util";
import {
    DataList,
    ID,
    Option,
...
export class SearchBar extends EventTarget {
    ...
    get onsearch(): (evt: Event) => any { return this.#onsearch; }
    set onsearch(v) { this.#onsearch = this.#replaceEventHandler("search", this.#onsearch, v); }
