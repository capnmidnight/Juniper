...
import { ClassList, CustomData, isAttr } from "@juniper-lib/dom/dist/attrs";
import { isCssElementStyleProp } from "@juniper-lib/dom/dist/css";
import { DD, DL, DT, H2, Label, HtmlRender, elementIsDisplayed, elementSetClass, elementSetDisplay, getElements, isDisableable, resolveElement } from "@juniper-lib/dom/dist/tags";
import { identity } from "@juniper-lib/tslib/dist/identity";
import { stringRandom } from "@juniper-lib/tslib/dist/strings/stringRandom";
import { isArray, isBoolean, isDate, isDefined, isNumber, isString } from "@juniper-lib/tslib/dist/typeChecks";
import "./styles.css";
class PropertyGroup {
