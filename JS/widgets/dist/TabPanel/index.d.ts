import { EventListenerOpts } from "@juniper-lib/dom/dist/evts";
...
export declare function onTabSelected<TabNames>(callback: (evt: TabPanelTabSelectedEvent<TabNames>) => void, opts?: EventListenerOpts): import("@juniper-lib/dom/dist/evts").HtmlEvt<TabPanelTabSelectedEvent<TabNames>>;
