...
import { isDefined, isGoodNumber, isNullOrUndefined, isNumber } from "./typeChecks";
export const RIGHT = /*@__PURE__*/ (function () { return new Vec3(1, 0, 0); })();
export const UP = /*@__PURE__*/ (function () { return new Vec3(0, 1, 0); })();
export const FWD = /*@__PURE__*/ (function () { return new Vec3(0, 0, -1); })();
export const Pi = /*@__PURE__*/ (function () { return Math.PI; })();
export const HalfPi = /*@__PURE__*/ (function () { return 0.5 * Pi; })();
export const Tau = /*@__PURE__*/ (function () { return 2 * Pi; })();
export const TWENTY_FOUR_LOG10 = /*@__PURE__*/ (function () { return 55.2620422318571; })();
export const LOG1000 = /*@__PURE__*/ (function () { return 6.90775527898214; })();
export const LOG2_DIV2 = /*@__PURE__*/ (function () { return 0.346573590279973; })();
export const EPSILON_FLOAT = /*@__PURE__*/ (function () { return 1e-8; })();
/**
...
export function formatBytes(value) {
    ...
    if (value < 0) {
        throw new Error(`Values less than 0 cannot be formatted as byte sizes. Value was: ${value}`);
    }
    if (value === 0) {
        return "0 B";
    }
    const size = Math.floor(Math.log(value) / Math.log(1000));
    const scalar = Math.pow(1000, size);
    let output = value / scalar;
    output *= 100;
    output = Math.round(output);
    output /= 100;
    return `${output} ${BYTE_SIZES[size]}`;
}
