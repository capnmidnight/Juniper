...
export const DEVELOPMENT = /* @__PURE__ */ (() =>
    /^https?:\/\/(?:localhost|127\.0\.0\.1)/.test(loc.href))();

export const STAGING = /* @__PURE__ */ (() =>
    !DEVELOPMENT
    && (/\/Test( |%20)Bed\//.test(loc.href)
        || /\/development\//.test(loc.href)))();

export const PRODUCTION = /* @__PURE__ */ (() =>
    !DEVELOPMENT
    && !STAGING)();
