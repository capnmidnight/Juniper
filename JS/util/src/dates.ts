 ...
 */
export function extractDate(str: string): Date {
...
function extractParts(formatter: Intl.DateTimeFormat, dateOrStringOrNumber: string | number | Date) {
...
Object.assign(globalThis, { formatDate });
 ...
 * Returns a string that is in "YYYY MMM DD" format.
 */
export function formatUSDate(date: string | number | Date) {
...
export function getMinDate(dates: Iterable<Date>) {
...
export function getMaxDate(dates: Iterable<Date>) {
...
export function dateISOToLocal(date: Date) {
    return new Date(
        date.getFullYear(),
        date.getMonth(),
        date.getDate(),
...
export function dateLocalToISO(date: Date) {
    return new Date(
        date.getFullYear(),
        date.getMonth(),
        date.getDate(),
