...
/**
 * Checks a value to make sure it's not `null` or `undefined`,
 * which is a stricter check than JavaScript's falsy checking,
 * as we sometimes care about `false`.
 */

export function hasValue(v: any): boolean { return v !== null && v !== undefined; }
