...
export const Message_News = /*@__PURE__*/ (function() { return message("news").deprecate("by RFC5537"); })();
...
export const Message_Vendor_SiSimp = /*@__PURE__*/ (function() { return message("vnd.si.simp").deprecate("by request"); })();
