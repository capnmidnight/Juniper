 ...
 **/
export declare class TaskEvent<EventT extends string, ResultsT = void> extends TypedEvent<EventT> implements Promise<ResultsT> {
    #private;
    /**
     ...
     **/
    get executionState(): import("./Task").TaskExecutionState;
    /**
    ...
    get resultState(): import("./Task").TaskResultState;
    /**
...
export {};
//# sourceMappingURL=TaskEvent.d.ts.map