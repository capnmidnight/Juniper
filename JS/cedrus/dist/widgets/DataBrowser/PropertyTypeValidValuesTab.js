...
export function PropertyValidValuesTab() {
    const dt = DataTable(ClassList("table", "table-striped", "border", "table-borderless", "border-dark", "table-hover"), DataColumn(TypeAttr("integer"), FieldAttr("id"), TitleAttr("ID")), DataColumn(TypeAttr("text"), FieldAttr("propertyType.name"), TitleAttr("Name")), DataColumn(TypeAttr("text"), FieldAttr("propertyType.dataType"), TitleAttr("Type")), DataColumn(TypeAttr("text"), FieldAttr("propertyType.unitsCategory"), TitleAttr("Units")), DataColumn(TypeAttr("text"), FieldAttr("value"), TitleAttr("Value")), DataColumn(TypeAttr("button"), IconAttr("trash"), EventAttr("delete"), HeaderAttr(""), TitleAttr("Delete")));
    const pane = DataBrowserPane("Property Type Valid Values", OnShown(() => withErrorAlert(async () => {
...
//# sourceMappingURL=PropertyTypeValidValuesTab.js.map