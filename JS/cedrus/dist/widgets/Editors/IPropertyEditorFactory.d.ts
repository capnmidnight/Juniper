...
export interface IPropertyEditorElement<DataTypeT extends DataType = DataType, StorageTypeT extends StorageType = StorageType> extends HTMLElement, InputFields {
    ...
    save(ds: CedrusDataAPI, entity: EntityModel, propertyType: PropertyTypeModel, unitOfMeasure: string, reference?: ENTITY): Promise<PropertyModel<DataTypeT, StorageTypeT>>;
}
export type IPropertyEditorFactory<DataTypeT extends DataType, StorageTypeT extends StorageType> = (...rest: ElementChild[]) => IPropertyEditorElement<DataTypeT, StorageTypeT>;
//# sourceMappingURL=IPropertyEditorFactory.d.ts.map