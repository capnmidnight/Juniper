...
export function FileTab() {
    ...
    const dt = DataTable<FileModel>(
        ...
        DataColumn(TypeAttr("text"), FieldAttr("type"), TitleAttr("Content Type")),
        DataColumn(TypeAttr("text"), FieldAttr("formattedSize"), TitleAttr("Size")),
        DataColumn(TypeAttr("link"), FieldAttr("path"), TitleAttr("Path")),
    ...
    const pane = DataBrowserPane("Files",
