import { EventReplacer, eventHandler, once, replaceEventHandler } from "@juniper-lib/util";
...
export class CombinedRequest<T> extends EventTarget implements IDBRequest<T[]> {
    ...
    set onsuccess(v) { this.#onsuccess = this.#replaceEventHandler("success", this.#onsuccess, v); }

    #onerror: eventHandler<Event> = null;
    get onerror() { return this.#onerror; }
    set onerror(v) { this.#onerror = this.#replaceEventHandler("error", this.#onerror, v); }
