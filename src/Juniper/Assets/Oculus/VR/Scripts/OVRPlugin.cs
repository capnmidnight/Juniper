...
#pragma warning restore CA1712 // Do not prefix enum values with type name
    ...
    {
        private float fx; /* Focal length in pixels along x axis. */
        private float fy; /* Focal length in pixels along y axis. */
        private float cx; /* Optical center along x axis, defined in pixels (usually close to width/2). */
        private float cy; /* Optical center along y axis, defined in pixels (usually close to height/2). */
        private double disto0; /* Distortion factor : [ k1, k2, p1, p2, k3 ]. Radial (k1,k2,k3) and Tangential (p1,p2) distortion.*/
        private double disto1;
        private double disto2;
        private double disto3;
        private double disto4;
        private float v_fov; /* Vertical field of view after stereo rectification, in degrees. */
        private float h_fov; /* Horizontal field of view after stereo rectification, in degrees.*/
        private float d_fov; /* Diagonal field of view after stereo rectification, in degrees.*/
        private int w; /* Resolution width */
        private int h; /* Resolution height */
    }
