...
namespace UnityEngine.XR.MagicLeap
{
    ...
    public sealed class ControllerConnectionHandler : MonoBehaviour
    {
        ...
        public DeviceTypesAllowed DevicesAllowed = (DeviceTypesAllowed)~0;
        ...
        /// </summary>
        public MLInputController ConnectedController => (_allowedConnectedDevices.Count == 0) ? null : _allowedConnectedDevices[0];
        #endregion
        ...
        private void Awake()
        {
            ...
            {
                var config = new MLInputConfiguration(MLInputConfiguration.DEFAULT_TRIGGER_DOWN_THRESHOLD,
        ...
        private void GetAllowedInput()
        {
            ...
            for (var i = 0; i < 2; ++i)
            {
                var controller = MLInput.GetController(i);
        ...
        private bool IsDeviceAllowed(MLInputController controller)
        {
            ...
            return (((DevicesAllowed & DeviceTypesAllowed.MobileApp) != 0 && controller.Type == MLInputControllerType.MobileApp) ||
                ((DevicesAllowed & DeviceTypesAllowed.ControllerLeft) != 0 && controller.Type == MLInputControllerType.Control && controller.Hand == MLInput.Hand.Left) ||
                ((DevicesAllowed & DeviceTypesAllowed.ControllerRight) != 0 && controller.Type == MLInputControllerType.Control && controller.Hand == MLInput.Hand.Right));
        }
        #endregion
        ...
        public bool IsControllerValid() => (ConnectedController != null);
        ...
        public bool IsControllerValid(byte controllerId) => _allowedConnectedDevices.Exists((device) => device.Id == controllerId);
        #endregion
        ...
        {
            var newController = MLInput.GetController(controllerId);
        ...
        private void HandleOnControllerDisconnected(byte controllerId)
        {
            ...
            var devicesRemoved = _allowedConnectedDevices.RemoveAll((device) => device.Id == controllerId);
