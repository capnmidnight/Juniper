...
#pragma warning restore CA1031 // Do not catch general exception types
        ...
        public void CaptureCubemap()
        {
            ...
            var curMask = MainCamera.cullingMask;
            MainCamera.cullingMask = LayerMask.GetMask("Photospheres");

            var curRotation = MainCamera.transform.rotation;
            MainCamera.transform.rotation = Quaternion.identity;

            MainCamera.RenderToCubemap(cubemap, 63);

            MainCamera.cullingMask = curMask;
            MainCamera.transform.rotation = curRotation;
            ...
            var fileName = Path.Combine(dir, "cubemap.jpeg");
