...
namespace Juniper.Unity.Input.Pointers.Motion
{
    ...
    /// </summary>
    public class HoloLensHand : AbstractWindowsMRDevice<HoloLensHandConfiguration, Haptics.NoHaptics>
    {
        /// <summary>
        ...
        {
            var unrotate = Quaternion.Inverse(DisplayManager.MainCamera.transform.rotation);
