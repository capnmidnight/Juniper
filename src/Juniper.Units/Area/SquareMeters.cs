namespace Juniper.Units
{
    ...
    public static class SquareMeters
    {
        ...
        /// </summary>
        public const double PER_SQUARE_MICROMETER = Meters.PER_MICROMETER * Meters.PER_MICROMETER;

        /// <summary>
        /// Conversion factor from square millimeters to square meters.
        /// </summary>
        public const double PER_SQUARE_MILLIMETER = Meters.PER_MILLIMETER * Meters.PER_MILLIMETER;

        /// <summary>
        /// Conversion factor from square millimeters to square meters.
        /// </summary>
        public const double PER_SQUARE_CENTIMETER = Meters.PER_CENTIMETER * Meters.PER_CENTIMETER;

        /// <summary>
        /// Conversion factor from square inches to square meters.
        /// </summary>
        public const double PER_SQUARE_INCH = Meters.PER_INCH * Meters.PER_INCH;

        /// <summary>
        /// Conversion factor from square feet to square meters.
        /// </summary>
        public const double PER_SQUARE_FOOT = Meters.PER_FOOT * Meters.PER_FOOT;

        /// <summary>
        /// Conversion factor from square yards to square meters.
        /// </summary>
        public const double PER_SQUARE_YARD = Meters.PER_YARD * Meters.PER_YARD;

        /// <summary>
        /// Conversion factor from square rod to square meters.
        /// </summary>
        public const double PER_SQUARE_ROD = Meters.PER_ROD * Meters.PER_ROD;
        ...
        /// </summary>
        public const double PER_SQUARE_KILOMETER = Meters.PER_KILOMETER * Meters.PER_KILOMETER;

        /// <summary>
        /// Conversion factor from square miles to square meters.
        /// </summary>
        public const double PER_SQUARE_MILE = Meters.PER_MILE * Meters.PER_MILE;
        ...
        public static double SquareMicrometers(double squareMeters)
        {
        ...
        public static double SquareMillimeters(double squareMeters)
        {
        ...
        public static double SquareCentimeters(double squareMeters)
        {
        ...
        public static double SquareInches(double squareMeters)
        {
        ...
        public static double SquareFeet(double squareMeters)
        {
        ...
        public static double SquareYards(double squareMeters)
        {
        ...
        public static double SquareRods(double squareMeters)
        {
        ...
        public static double Acres(double squareMeters)
        {
        ...
        public static double SquareKilometers(double squareMeters)
        {
        ...
        public static double SquareMiles(double squareMeters)
        {
