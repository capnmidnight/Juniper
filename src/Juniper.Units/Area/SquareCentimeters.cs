namespace Juniper.Units
{
    ...
    public static class SquareCentimeters
    {
        ...
        /// </summary>
        public const double PER_SQUARE_MICROMETER = Centimeters.PER_MICROMETER * Centimeters.PER_MICROMETER;

        /// <summary>
        /// Conversion factor from square millimeters to square centimeters.
        /// </summary>
        public const double PER_SQUARE_MILLIMETER = Centimeters.PER_MILLIMETER * Centimeters.PER_MILLIMETER;

        /// <summary>
        /// Conversion factor from square inches to square centimeters.
        /// </summary>
        public const double PER_SQUARE_INCH = Centimeters.PER_INCH * Centimeters.PER_INCH;

        /// <summary>
        /// Conversion factor from square feet to square centimeters.
        /// </summary>
        public const double PER_SQUARE_FOOT = Centimeters.PER_FOOT * Centimeters.PER_FOOT;

        /// <summary>
        /// Conversion factor from square yards to square centimeters.
        /// </summary>
        public const double PER_SQUARE_YARD = Centimeters.PER_YARD * Centimeters.PER_YARD;

        /// <summary>
        /// Conversion factor from square meters to square centimeters.
        /// </summary>
        public const double PER_SQUARE_METER = Centimeters.PER_METER * Centimeters.PER_METER;

        /// <summary>
        /// Conversion factor from square rod to square centimeters.
        /// </summary>
        public const double PER_SQUARE_ROD = Centimeters.PER_ROD * Centimeters.PER_ROD;
        ...
        /// </summary>
        public const double PER_SQUARE_KILOMETER = Centimeters.PER_KILOMETER * Centimeters.PER_KILOMETER;

        /// <summary>
        /// Conversion factor from square miles to square centimeters.
        /// </summary>
        public const double PER_SQUARE_MILE = Centimeters.PER_MILE * Centimeters.PER_MILE;
        ...
        public static double SquareMicrometers(double squareCentimeters)
        {
        ...
        public static double SquareMillimeters(double squareCentimeters)
        {
        ...
        public static double SquareInches(double squareCentimeters)
        {
        ...
        public static double SquareFeet(double squareCentimeters)
        {
        ...
        public static double SquareYards(double squareCentimeters)
        {
        ...
        public static double SquareMeters(double squareCentimeters)
        {
        ...
        public static double SquareRods(double squareCentimeters)
        {
        ...
        public static double Acres(double squareCentimeters)
        {
        ...
        public static double SquareKilometers(double squareCentimeters)
        {
        ...
        public static double SquareMiles(double squareCentimeters)
        {
