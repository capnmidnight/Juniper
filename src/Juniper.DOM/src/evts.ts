import { BaseProgress, IProgress, isFunction, isHTMLElement } from "juniper-tslib";
...
export function onAppInstalled(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("appinstalled", callback, opts); }
export function _onAudioProcess(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("audioprocess", callback, opts); }
export function onAudioEnd(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("audioend", callback, opts); }
export function onAudioStart(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("audiostart", callback, opts); }
...
export function onBlocked(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("blocked", callback, opts); }
export function onBlur(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("blur", callback, opts); }
export function onBoundary(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("boundary", callback, opts); }
...
export function onChargingChange(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("chargingchange", callback, opts); }
export function onChargingTimeChange(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("chargingtimechange", callback, opts); }
export function onChecking(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("checking", callback, opts); }
...
export function onComplete(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("complete", callback, opts); }
...
export function onDeviceChange(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("devicechange", callback, opts); }
export function onDeviceMotion(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("devicemotion", callback, opts); }
export function onDeviceOrientation(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("deviceorientation", callback, opts); }
export function onDischargingTimeChange(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("dischargingtimechange", callback, opts); }
export function onDownloading(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("downloading", callback, opts); }
...
export function onEnd(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("end", callback, opts); }
...
export function onLevelChange(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("levelchange", callback, opts); }
...
export function onLoadEnd(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("loadend", callback, opts); }
export function onLoadStart(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("loadstart", callback, opts); }
export function onMark(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("mark", callback, opts); }
...
export function onMouseDown(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("mousedown", callback, opts); }
export function onMouseEnter(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("mouseenter", callback, opts); }
export function onMouseLeave(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("mouseleave", callback, opts); }
export function onMouseMove(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("mousemove", callback, opts); }
export function onMouseOut(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("mouseout", callback, opts); }
export function onMouseOver(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("mouseover", callback, opts); }
export function onMouseUp(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("mouseup", callback, opts); }
export function onNoMatch(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("nomatch", callback, opts); }
export function onNotificationClick(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("notificationclick", callback, opts); }
export function onNoUpdate(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("noupdate", callback, opts); }
export function onObsolete(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("obsolete", callback, opts); }
...
export function onOpen(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("open", callback, opts); }
...
export function onPointerCancel(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("pointercancel", callback, opts); }
export function onPointerDown(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("pointerdown", callback, opts); }
export function onPointerEnter(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("pointerenter", callback, opts); }
export function onPointerLeave(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("pointerleave", callback, opts); }
export function onPointerLockChange(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("pointerlockchange", callback, opts); }
export function onPointerLockError(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("pointerlockerror", callback, opts); }
export function onPointerMove(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("pointermove", callback, opts); }
export function onPointerOut(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("pointerout", callback, opts); }
export function onPointerOver(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("pointerover", callback, opts); }
export function onPointerUp(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("pointerup", callback, opts); }
...
export function onResourceTimingBufferFull(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("resourcetimingbufferfull", callback, opts); }
export function onResult(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("result", callback, opts); }
export function onResume(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("resume", callback, opts); }
...
export function onShow(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("show", callback, opts); }
export function onSlotChange(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("slotchange", callback, opts); }
export function onSoundEnd(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("soundend", callback, opts); }
export function onSoundStart(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("soundstart", callback, opts); }
export function onSpeechEnd(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("speechend", callback, opts); }
export function onSpeechStart(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("speechstart", callback, opts); }
export function onStalled(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("stalled", callback, opts); }
export function onStart(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("start", callback, opts); }
...
export function onSuccess(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("success", callback, opts); }
export function onSuspend(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("suspend", callback, opts); }
export function onSVGAbort(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("SVGAbort", callback, opts); }
export function onSVGError(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("SVGError", callback, opts); }
export function onSVGLoad(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("SVGLoad", callback, opts); }
export function onSVGResize(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("SVGResize", callback, opts); }
export function onSVGScroll(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("SVGScroll", callback, opts); }
export function onSVGUnload(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("SVGUnload", callback, opts); }
export function onSVGZoom(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("SVGZoom", callback, opts); }
export function onTimeout(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("timeout", callback, opts); }
...
export function onUpdateReady(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("updateready", callback, opts); }
export function onUpgradeNeeded(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("upgradeneeded", callback, opts); }
export function onUserProximity(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("userproximity", callback, opts); }
export function onVoicesChanged(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("voiceschanged", callback, opts); }
export function onVersionChange(callback: (evt: Event) => void, opts?: EventListenerOpts) { return new HtmlEvt("versionchange", callback, opts); }
