...
export declare function resolveElement(elem: Elements): HTMLElement;
...
export declare function elementApply(elem: Elements, ...children: ElementChild[]): Elements;
...
export declare function elementGetText(elem: Elements): string;
...
export declare function BackgroundAudio(autoplay: boolean, mute: boolean, looping: boolean, ...rest: ElementChild[]): HTMLAudioElement;
export declare function BackgroundVideo(autoplay: boolean, mute: boolean, looping: boolean, ...rest: ElementChild[]): HTMLVideoElement;
