 ...
 */
export declare function openWindow(href: string | URL): void;
export declare function openWindow(href: string | URL, width: number, height: number): void;
export declare function openWindow(href: string | URL, x: number, y: number, width: number, height: number): void;
/**
