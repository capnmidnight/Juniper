...
import { TypedEvent, TypedEventBase, TypedEventMap } from "./TypedEventBase";
...
export function eventScope<EventMapT extends TypedEventMap<string>, EventT extends string & keyof EventMapT = string & keyof EventMapT>(target: TypedEventBase<EventMapT> | EventTarget, eventName: EventT, eventHandler: (evt: TypedEvent<EventT> & EventMapT[EventT]) => any): EventScope;
