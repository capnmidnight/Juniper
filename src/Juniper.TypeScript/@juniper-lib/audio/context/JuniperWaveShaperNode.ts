...
export class JuniperWaveShaperNode extends WaveShaperNode implements IAudioNode {
    constructor(private readonly jctx: JuniperAudioContext, options?: WaveShaperOptions) {
        super(jctx, options);
        this.jctx._init("wave-shaper", this);
    }
