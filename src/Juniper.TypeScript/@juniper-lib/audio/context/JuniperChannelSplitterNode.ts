...
export class JuniperChannelSplitterNode extends ChannelSplitterNode implements IAudioNode {
    constructor(private readonly jctx: JuniperAudioContext, options?: ChannelSplitterOptions) {
        super(jctx, options);
        this.jctx._init("channel-splitter", this);
    }
