...
export class JuniperChannelMergerNode extends ChannelMergerNode implements IAudioNode {
    constructor(private readonly jctx: JuniperAudioContext, options?: ChannelMergerOptions) {
        super(jctx, options);
        this.jctx._init("channel-merger", this);
    }
