...
export class JuniperConvolverNode extends ConvolverNode implements IAudioNode {
    constructor(private readonly jctx: JuniperAudioContext, options?: ConvolverOptions) {
        super(jctx, options);
        this.jctx._init("convolver", this);
    }
