...
export class JuniperMediaStreamAudioDestinationNode extends MediaStreamAudioDestinationNode implements IAudioNode {
    constructor(private readonly jctx: JuniperAudioContext, options?: AudioNodeOptions) {
        super(jctx, options);
        this.jctx._init("media-stream-audio-destination", this);
    }
