...
export class URLBuilderTests extends TestCase {
    ...
    test_UndefinedConstructor() {
        this.doesNotThrow(() => new URLBuilder(undefined));
    }
    test_UndefinedUndefinedConstructor() {
        this.doesNotThrow(() => new URLBuilder(undefined, undefined));
    }
    test_UndefinedNullConstructor() {
        this.doesNotThrow(() => new URLBuilder(undefined, null));
    }
    test_NullConstructor() {
        this.throws(() => new URLBuilder(null));
    }
    test_NullUndefinedConstructor() {
        this.throws(() => new URLBuilder(null, undefined));
    }
    ...
    test_RelativeConstructorWithUndefinedBase() {
        this.throws(() => new URLBuilder("image.jpg", undefined));
    }
