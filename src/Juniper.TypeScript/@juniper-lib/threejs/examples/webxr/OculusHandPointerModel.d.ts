...
export class OculusHandPointerModel extends Object3D {
    ...
    public intersectObject(object: Object3D, recursive: boolean = true): Intersection[] | void;

    public intersectObjects(objects: Object3D[], recursive: boolean = true): Intersection[] | void;

    public checkIntersections(objects: Object3D[], recursive: boolean = true): void;
