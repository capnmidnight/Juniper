...
export function animation(...v: (string | number)[]): CssProp;
export function animation(...v: (string | number)[]): CssProp { return new CssProp("animation", v.join(" ")); }
...
export function backgroundPosition(x: CSSLengthPercentage, y: CSSLengthPercentage): CssProp;
export function backgroundPosition(x: CSSPositionHorizontalKeyword, y: CSSPositionVerticalValue): CssProp;
export function backgroundPosition(y: CSSPositionVerticalKeyword, x: CSSPositionHorizontalValue): CssProp;
export function backgroundPosition(x: CSSPositionHorizontalKeyword, y: CSSPositionVerticalKeyword, yOffset: CSSLengthPercentage): CssProp;
export function backgroundPosition(x: CSSPositionHorizontalKeyword, xOffset: CSSLengthPercentage, y: CSSPositionVerticalKeyword): CssProp;
export function backgroundPosition(y: CSSPositionVerticalKeyword, x: CSSPositionHorizontalKeyword, xOffset: CSSLengthPercentage): CssProp;
export function backgroundPosition(y: CSSPositionVerticalKeyword, yOffset: CSSLengthPercentage, x: CSSPositionHorizontalKeyword): CssProp;
export function backgroundPosition(x: CSSPositionHorizontalKeyword, xOffset: CSSLengthPercentage, y: CSSPositionVerticalKeyword, yOffset: CSSLengthPercentage): CssProp;
export function backgroundPosition(y: CSSPositionVerticalKeyword, yOffset: CSSLengthPercentage, x: CSSPositionHorizontalKeyword, xOffset: CSSLengthPercentage): CssProp;
...
export function backgroundPositionX(x: CSSPositionHorizontalValue): CssProp;
export function backgroundPositionX(x: CSSPositionHorizontalKeyword, xOffset: CSSLengthPercentage): CssProp;
...
export function backgroundPositionY(y: CSSPositionVerticalValue): CssProp;
export function backgroundPositionY(y: CSSPositionVerticalKeyword, yOffset: CSSLengthPercentage): CssProp;
...
export function transformBox(v: CSSGlobalValues | CSSTransformBoxValue) { return new CssProp("transformBox", v); }

export function transformOrigin(v: CSSGlobalValues): CssProp;
export function transformOrigin(v: CSSLengthPercentage | CSSPositionKeyword): CssProp;
export function transformOrigin(x: CSSLengthPercentage | CSSPositionHorizontalKeyword, y: CSSLengthPercentage | CSSPositionVerticalKeyword): CssProp;
export function transformOrigin(x: CSSLengthPercentage | CSSPositionHorizontalKeyword, y: CSSLengthPercentage | CSSPositionVerticalKeyword, z: CSSLength): CssProp;
export function transformOrigin(...v: (string | number)[]): CssProp { return new CssProp("transformOrigin", v.join(" ")); }

export function transformStyle(v: CSSGlobalValues | CSSTransformStyleValue) { return new CssProp("transformStyle", v); }
