...
export function onTouchCancel(callback: (evt: TouchEvent) => void, opts?: EventListenerOpts) { return new HtmlEvt("touchcancel", callback, opts); }
export function onTouchEnd(callback: (evt: TouchEvent) => void, opts?: EventListenerOpts) { return new HtmlEvt("touchend", callback, opts); }
export function onTouchMove(callback: (evt: TouchEvent) => void, opts?: EventListenerOpts) { return new HtmlEvt("touchmove", callback, opts); }
export function onTouchStart(callback: (evt: TouchEvent) => void, opts?: EventListenerOpts) { return new HtmlEvt("touchstart", callback, opts); }
