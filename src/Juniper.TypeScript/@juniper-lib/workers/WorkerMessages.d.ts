...
export type WorkerServerMessageType = "error" | "progress" | "return" | "event";
...
export interface WorkerServerEventMessage<EventMap> extends WorkerServerMessage<"event"> {
...
export type WorkerServerMessages<EventMap> = WorkerServerErrorMessage | WorkerServerProgressMessage | WorkerServerReturnMessage | WorkerServerEventMessage<EventMap>;
export {};
