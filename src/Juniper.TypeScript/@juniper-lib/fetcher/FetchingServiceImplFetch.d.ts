...
export declare class FetchingServiceImplFetch implements IFetchingServiceImpl {
    ...
    sendSomethingGetSomething<K extends keyof (XMLHttpRequestResponseTypeMap), T extends XMLHttpRequestResponseTypeMap[K]>(xhrType: K, request: IRequestWithBody, defaultPostHeaders: Map<string, string>, _progress: IProgress): Promise<IResponse<T>>;
}
//# sourceMappingURL=FetchingServiceImplFetch.d.ts.map