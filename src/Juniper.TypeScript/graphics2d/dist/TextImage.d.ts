import { CanvasImage, CanvasImageOptions, Context2D } from "juniper-dom";
import { PaddingRect, TypedEvent } from "juniper-tslib";
export declare type TextDirection = "horizontal" | "vertical";
