...
//disguisedFace,
pleadingFace, faceWithMonocle, skullAndCrossbones, frowningFace, smilingFace, speakingHead, bustInSilhouette, } from ".";
export const faces = /*@__PURE__*/ G("Faces", "Round emoji faces", {
    ogre,
    goblin,
    ghost,
    alien,
