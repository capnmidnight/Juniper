 ...
 */
declare type readItemCallback<T, V> = (obj: T) => V;
export declare type makeItemCallback<T> = readItemCallback<T, string>;
export declare type makeLabelCallback<T> = readItemCallback<T, ElementChild>;
...
declare class SelectBoxRow<T> extends TypedEventBase<SelectBoxEvents<T>> implements ErsatzElement {
    id: string;
    private _value;
    private _contents;
    private _sortKey;
 ...
 **/
export declare class SelectBox<T> extends TypedEventBase<SelectBoxEvents<T>> implements ErsatzElement {
    private makeID;
    private makeLabel;
    private getSortKey;
