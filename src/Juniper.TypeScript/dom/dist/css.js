...
export function gridTemplateAreas(...v) { return new CssProp("gridTemplateAreas", v.map(r => '"' + r + '"').join('\n')); }
...
export function zIndex(v) { return new CssProp("zIndex", isNumber(v) ? v.toFixed(0) : v); }
export function zoom(v) { return new CssProp("zoom", isNumber(v) ? v.toFixed(0) : v); }
/**
