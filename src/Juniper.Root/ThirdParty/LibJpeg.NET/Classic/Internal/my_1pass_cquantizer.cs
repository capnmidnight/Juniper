...
namespace BitMiracle.LibJpeg.Classic.Internal
{
    ...
    internal class my_1pass_cquantizer : jpeg_color_quantizer
    {
        ...
        */
        ...
        public virtual void start_pass(bool is_pre_scan)
        {
            ...
            switch (m_cinfo.m_dither_mode)
            {
                ...
                case J_DITHER_MODE.JDITHER_FS:
                    ...
                    var arraysize = m_cinfo.m_output_width + 2;
                    for (var i = 0; i < m_cinfo.m_out_color_components; i++)
                    {
        ...
        {
            var nc = m_cinfo.m_out_color_components;
        ...
        {
            var width = m_cinfo.m_output_width;
        ...
        private void create_colormap()
        {
            ...
            var total_colors = select_ncolors(m_Ncolors);
            ...
            var colormap = jpeg_common_struct.AllocJpegSamples(total_colors, m_cinfo.m_out_color_components);
        ...
        private void create_colorindex()
        {
            ...
            for (var i = 0; i < m_cinfo.m_out_color_components; i++)
            {
                ...
                var val = 0;
                var k = largest_input_value(0, nci - 1);
        ...
        {
            var nc = m_cinfo.m_out_color_components; /* number of color components */
            var max_colors = m_cinfo.m_desired_number_of_colors;
            ...
            do
            {
                ...
                for (var i = 0; i < nc; i++)
                {
                    var j = (m_cinfo.m_out_color_space == J_COLOR_SPACE.JCS_RGB ? RGB_order[i] : i);
