namespace Juniper.Units
{
    ...
    {
        public const float PER_CUBIC_MICROMETER = 1 / Units.CubicMicrometers.PER_GILL;
        public const float PER_CUBIC_MILLIMETER = 1 / Units.CubicMillimeters.PER_GILL;
        public const float PER_CUBIC_CENTIMETER = 1 / Units.CubicCentimeters.PER_GILL;
        public const float PER_MINIM = 1 / Units.Minims.PER_GILL;
        public const float PER_MILLILITER = 1 / Units.Milliliters.PER_GILL;
        public const float PER_FLUID_DRAM = 1 / Units.FluidDrams.PER_GILL;
        public const float PER_TEASPOON = 1 / Units.Teaspoons.PER_GILL;
        public const float PER_TABLESPOON = 1 / Units.Tablespoons.PER_GILL;
        public const float PER_CUBIC_INCH = 1 / Units.CubicInches.PER_GILL;
        public const float PER_FLUID_OUNCE = 1 / Units.FluidOunces.PER_GILL;
        public const float PER_GILL = 1;
        public const float PER_CUP = 2;
        ...
        public static float CubicMicrometers(float gills)
        {
        ...
        public static float CubicMillimeters(float gills)
        {
            return gills * Units.CubicMillimeters.PER_GILL;
        }

        public static float Minims(float gills)
        {
        ...
        public static float CubicCentimeters(float gills)
        {
        ...
        public static float Milliliters(float gills)
        {
            return CubicCentimeters(gills);
        }

        public static float FluidDrams(float gills)
        {
            return gills * Units.FluidDrams.PER_GILL;
        }

        public static float Teaspoons(float gills)
        {
            return gills * Units.Teaspoons.PER_GILL;
        }

        public static float Tablespoons(float gills)
        {
        ...
        public static float CubicInches(float gills)
        {
            return gills * Units.CubicInches.PER_GILL;
        }

        public static float FluidOunces(float gills)
        {
            return gills * Units.FluidOunces.PER_GILL;
        }

        public static float Cups(float gills)
        {
            return gills * Units.Cups.PER_GILL;
        }

        public static float LiquidPints(float gills)
        {
            return gills * Units.LiquidPints.PER_GILL;
        }

        public static float LiquidQuarts(float gills)
        {
        ...
        public static float Liters(float gills)
        {
            return gills * Units.Liters.PER_GILL;
        }

        public static float Gallons(float gills)
        {
        ...
        public static float CubicFeet(float gills)
        {
        ...
        public static float CubicMeters(float gills)
        {
        ...
        public static float Kiloliters(float gills)
        {
        ...
        public static float CubicKilometers(float gills)
        {
        ...
        public static float CubicMiles(float gills)
        {
