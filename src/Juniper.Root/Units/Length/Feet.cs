namespace Juniper.Units
{
    ...
    public static class Feet
    {
        ...
        /// </summary>
        public const float PER_ROD = 16.5f;
        ...
        public static float Yards(float feet)
        {
        ...
        public static float Rods(float feet)
        {
        ...
        public static float Furlongs(float feet)
        {
