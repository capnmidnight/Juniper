namespace Juniper.Units
{
    ...
    public static class SquareYards
    {
        ...
        /// </summary>
        public const float PER_SQUARE_MICROMETER = Yards.PER_MICROMETER * Yards.PER_MICROMETER;

        /// <summary>
        /// Conversion factor from square millimeters to square yards.
        /// </summary>
        public const float PER_SQUARE_MILLIMETER = Yards.PER_MILLIMETER * Yards.PER_MILLIMETER;

        /// <summary>
        /// Conversion factor from square centimeters to square yards.
        /// </summary>
        public const float PER_SQUARE_CENTIMETER = Yards.PER_CENTIMETER * Yards.PER_CENTIMETER;

        /// <summary>
        /// Conversion factor from square inches to square yards.
        /// </summary>
        public const float PER_SQUARE_INCH = Yards.PER_INCH * Yards.PER_INCH;

        /// <summary>
        /// Conversion factor from square yards to square yards.
        /// </summary>
        public const float PER_SQUARE_FOOT = Yards.PER_FOOT * Yards.PER_FOOT;

        /// <summary>
        /// Conversion factor from square rod to square yards.
        /// </summary>
        public const float PER_SQUARE_ROD = Yards.PER_ROD * Yards.PER_ROD;
        ...
        /// </summary>
        public const float PER_SQUARE_METER = Yards.PER_METER * Yards.PER_METER;

        /// <summary>
        /// Conversion factor from square kilometers to square yards.
        /// </summary>
        public const float PER_SQUARE_KILOMETER = Yards.PER_KILOMETER * Yards.PER_KILOMETER;

        /// <summary>
        /// Conversion factor from square miles to square yards.
        /// </summary>
        public const float PER_SQUARE_MILE = Yards.PER_MILE * Yards.PER_MILE;
        ...
        public static float SquareMicrometers(float squareYards)
        {
        ...
        public static float SquareMillimeters(float squareYards)
        {
        ...
        public static float SquareCentimeters(float squareYards)
        {
        ...
        public static float SquareInches(float squareYards)
        {
        ...
        public static float SquareFeet(float squareYards)
        {
        ...
        /// <param name="squareYards">The number of square yards</param>
        /// <returns>The number of square centimeters</returns>
        public static float SquareMeters(float squareYards)
        {
        ...
        public static float SquareRods(float squareYards)
        {
        ...
        public static float Acres(float squareYards)
        {
        ...
        public static float SquareKilometers(float squareYards)
        {
        ...
        public static float SquareMiles(float squareYards)
        {
