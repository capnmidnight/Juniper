namespace Juniper
{
    public partial class MediaType
    {
        ...
        public static readonly Message Message_ImdnXml = new("imdn+xml", new string[] { "xml" });
        ...
        public static readonly Message Message_Rfc822 = new("rfc822", new string[] { "eml", "mime" });
        ...
        public static readonly Message Message_VendorSiSimp = new("vnd.si.simp");

        public static readonly Message Message_VendorWfaWsc = new("vnd.wfa.wsc");
    }
}
