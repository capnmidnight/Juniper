    ...
    where MediaTypeT : MediaType
{
    ...
    {
        SetQuery(key, value?.ToString() ?? throw new ArgumentNullException(nameof(value)));
    }
    ...
    {
        return RemoveQuery(key, value?.ToString() ?? throw new ArgumentNullException(nameof(value)));
    }
