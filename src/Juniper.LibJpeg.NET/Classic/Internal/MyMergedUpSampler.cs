...
{
    internal class MyMergedUpSampler : JpegUpSampler
    {
        ...
        */
        ...
        public override void UpSample(ComponentBuffer[] input_buf, ref int in_row_group_ctr, int in_row_groups_avail, byte[][] output_buf, ref int out_row_ctr, int out_rows_avail)
        {
            ...
            {
                Merged2VUpSample(input_buf, ref in_row_group_ctr, output_buf, ref out_row_ctr, out_rows_avail);
            }
            else
            {
                Merged1VUpSample(input_buf, ref in_row_group_ctr, output_buf, ref out_row_ctr);
            }
        }
        ...
        /// </summary>
        private void Merged1VUpSample(ComponentBuffer[] input_buf, ref int in_row_group_ctr, byte[][] output_buf, ref int out_row_ctr)
        {
            /* Just do the upsampling. */
            H2V1MergedUpSample(input_buf, in_row_group_ctr, output_buf, out_row_ctr);
        ...
        /// </summary>
        private void Merged2VUpSample(ComponentBuffer[] input_buf, ref int in_row_group_ctr, byte[][] output_buf, ref int out_row_ctr, int out_rows_avail)
        {
            ...
            else
            {
                ...
                H2V2MergedUpSample(input_buf, in_row_group_ctr, work_ptrs);
            }
        ...
        /// </summary>
        private void H2V1MergedUpSample(ComponentBuffer[] input_buf, int in_row_group_ctr, byte[][] output_buf, int outRow)
        {
            var inputIndex0 = 0;
            var inputIndex1 = 0;
            var inputIndex2 = 0;
