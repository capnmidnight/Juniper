...
export class MediaType {
    ...
    constructor(typeName, _subTypeName, weightOrExtensions, extensions) {
        this.typeName = typeName;
        this._subTypeName = _subTypeName;
...
const specialize = (group) => (value, ...extensions) => register(new MediaType(group, value, extensions));
