...
namespace Juniper.Units
{
    ...
    public static partial class Converter
    {
        ...
        public static float Convert(this float value, UnitOfMeasure fromUnit, UnitOfMeasure toUnit)
        {
            ...
            {
                throw new InvalidCastException($"Cannot convert {value.ToString()} in {fromUnit.ToString()} to {toUnit.ToString()}.");
            }
        }
        ...
        {
            return Abbreviations.ContainsKey(unit) ? Abbreviations[unit] : string.Empty;
        }
