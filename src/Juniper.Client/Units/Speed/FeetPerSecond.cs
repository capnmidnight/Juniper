namespace Juniper.Units
{
    ...
    public static class FeetPerSecond
    {
        ...
        /// </summary>
        public const float PER_MILE_PER_HOUR = Units.Feet.PER_MILE / Units.Seconds.PER_HOUR;

        /// <summary>
        /// Conversion factor from kilometers per hour to feet per second.
        /// </summary>
        public const float PER_KILOMETER_PER_HOUR = Units.Feet.PER_KILOMETER / Units.Seconds.PER_HOUR;

        /// <summary>
        /// Conversion factor from meters per second to feet per second.
        /// </summary>
        public const float PER_METER_PER_SECOND = Units.Feet.PER_METER;

        /// <summary>
        /// Conversion factor from millimeters per second to feet per second.
        /// </summary>
        public const float PER_MILLIMETER_PER_SECOND = Units.Feet.PER_MILLIMETER;
        ...
        public static float MilesPerHour(float fps)
        {
        ...
        public static float KilometersPerHour(float fps)
        {
        ...
        public static float MetersPerSecond(float fps)
        {
        ...
        public static float MillimetersPerSecond(float fps)
        {
