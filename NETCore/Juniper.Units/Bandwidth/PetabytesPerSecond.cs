namespace Juniper.Units
{
    ...
    public static class PetabytesPerSecond
    {
        ...
        /// </summary>
        public const double PER_BIT_PER_SECOND = 1 / Units.BitsPerSecond.PER_PETABYTE_PER_SECOND;

        /// <summary>
        /// The number of petabytes per second per byte per second
        /// </summary>
        public const double PER_BYTE_PER_SECOND = 1 / Units.BytesPerSecond.PER_PETABYTE_PER_SECOND;

        /// <summary>
        /// The number of petabytes per second per kilobyte per second
        /// </summary>
        public const double PER_KILOBYTE_PER_SECOND = 1 / Units.KilobytesPerSecond.PER_PETABYTE_PER_SECOND;

        /// <summary>
        /// The number of petabytes per second per megabyte per second
        /// </summary>
        public const double PER_MEGABYTE_PER_SECOND = 1 / Units.MegabytesPerSecond.PER_PETABYTE_PER_SECOND;

        /// <summary>
        /// The number of petabytes per second per gigabyte per second
        /// </summary>
        public const double PER_GIGABYTE_PER_SECOND = 1 / Units.GigabytesPerSecond.PER_PETABYTE_PER_SECOND;

        /// <summary>
        /// The number of petabytes per second per terabyte per second
        /// </summary>
        public const double PER_TERABYTE_PER_SECOND = 1 / Units.TerabytesPerSecond.PER_PETABYTE_PER_SECOND;

        /// <summary>
        /// The number of petabytes per second per exabyte per second
        /// </summary>
        public const double PER_EXABYTE_PER_SECOND = 1000;
        ...
        /// </summary>
        public const double PER_KIBIBYTE_PER_SECOND = 1 / Units.KibibytesPerSecond.PER_PETABYTE_PER_SECOND;

        /// <summary>
        /// The number of petabytes per second per mibibyte per second
        /// </summary>
        public const double PER_MIBIBYTE_PER_SECOND = 1 / Units.MibibytesPerSecond.PER_PETABYTE_PER_SECOND;

        /// <summary>
        /// The number of petabytes per second per gibibyte per second
        /// </summary>
        public const double PER_GIBIBYTE_PER_SECOND = 1 / Units.GibibytesPerSecond.PER_PETABYTE_PER_SECOND;

        /// <summary>
        /// The number of petabytes per second per tebibyte per second
        /// </summary>
        public const double PER_TEBIBYTE_PER_SECOND = 1 / Units.TebibytesPerSecond.PER_PETABYTE_PER_SECOND;

        /// <summary>
        /// The number of petabytes per second per pebibyte per second
        /// </summary>
        public const double PER_PEBIBYTE_PER_SECOND = Units.BytesPerSecond.PER_PEBIBYTE_PER_SECOND / Units.BytesPerSecond.PER_PETABYTE_PER_SECOND;
        ...
        public static double BitsPerSecond(double petabytesPerSecond)
        {
        ...
        public static double BytesPerSecond(double petabytesPerSecond)
        {
        ...
        public static double KilobytesPerSecond(double petabytesPerSecond)
        {
        ...
        public static double MegabytesPerSecond(double petabytesPerSecond)
        {
        ...
        public static double GigabytesPerSecond(double petabytesPerSecond)
        {
        ...
        public static double TerabytesPerSecond(double petabytesPerSecond)
        {
        ...
        public static double ExabytesPerSecond(double petabytesPerSecond)
        {
        ...
        public static double ZettabytesPerSecond(double petabytesPerSecond)
        {
        ...
        public static double YotabytesPerSecond(double petabytesPerSecond)
        {
        ...
        public static double KibibytesPerSecond(double petabytesPerSecond)
        {
        ...
        public static double MibibytesPerSecond(double petabytesPerSecond)
        {
        ...
        public static double GibibytesPerSecond(double petabytesPerSecond)
        {
        ...
        public static double TebibytesPerSecond(double petabytesPerSecond)
        {
        ...
        public static double PebibytesPerSecond(double petabytesPerSecond)
        {
        ...
        public static double ExbibytesPerSecond(double petabytesPerSecond)
        {
        ...
        public static double ZebibytesPerSecond(double petabytesPerSecond)
        {
        ...
        public static double YobibytesPerSecond(double petabytesPerSecond)
        {
