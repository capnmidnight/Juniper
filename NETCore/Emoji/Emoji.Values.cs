...
public partial class Emoji
{
    ...
    public static readonly IReadOnlyList<Emoji> combiners = [
        textStyle,
        emojiStyle,
        zeroWidthJoiner,
    ...
    public static readonly IReadOnlyList<Emoji> sexes = [
        female,
        male,
    ];
    ...
    public static readonly IReadOnlyList<Emoji> skinTones = [
        skinL,
        skinML,
        skinM,
        skinMD,
    ...
    public static readonly IReadOnlyList<Emoji> hairColors = [
        hairRed,
        hairCurly,
        hairWhite,
        hairBald,
    ...
    public static readonly Emoji eyes = new(0x1F440, "Eyes");
    public static readonly Emoji eye = new(0x1F441 + emojiStyle, "Eye");
    public static readonly Emoji eyeInSpeechBubble = new(0x1F441 + emojiStyle + zeroWidthJoiner + 0x1F5E8 + emojiStyle, "Eye in Speech Bubble");
    public static readonly Emoji ear = new(0x1F442, "Ear");
    public static readonly Emoji nose = new(0x1F443, "Nose");
    public static readonly Emoji mouth = new(0x1F444, "Mouth");
    public static readonly Emoji tongue = new(0x1F445, "Tongue");
    public static readonly Emoji flexedBicep = new(0x1F4AA, "Flexed Biceps");
    public static readonly Emoji selfie = new(0x1F933, "Selfie");
    public static readonly Emoji bone = new(0x1F9B4, "Bone");
    public static readonly Emoji leg = new(0x1F9B5, "Leg");
    public static readonly Emoji foot = new(0x1F9B6, "Foot");
    public static readonly Emoji tooth = new(0x1F9B7, "Tooth");
    public static readonly Emoji earWithHearingAid = new(0x1F9BB, "Ear with Hearing Aid");
    public static readonly Emoji mechanicalArm = new(0x1F9BE, "Mechanical Arm");
    public static readonly Emoji mechanicalLeg = new(0x1F9BF, "Mechanical Leg");
    public static readonly Emoji anatomicalHeart = new(0x1FAC0, "Anatomical Heart");
    public static readonly Emoji lungs = new(0x1FAC1, "Lungs");
    public static readonly Emoji brain = new(0x1F9E0, "Brain");
    ...
    public static readonly Emoji pen = new(0x1F58A + emojiStyle, "Pen");
    public static readonly Emoji fountainPen = new(0x1F58B + emojiStyle, "Fountain Pen");
    public static readonly Emoji paintbrush = new(0x1F58C + emojiStyle, "Paintbrush");
    public static readonly Emoji crayon = new(0x1F58D + emojiStyle, "Crayon");
    public static readonly Emoji pencil = new("\u270F" + emojiStyle, "Pencil");
    public static readonly Emoji blackNib = new("\u2712" + emojiStyle, "Black Nib");
    ...
    public static readonly Emoji fileFolder = new(0x1F4C1, "File Folder");
    public static readonly Emoji openFileFolder = new(0x1F4C2, "Open File Folder");
    public static readonly Emoji pageWithCurl = new(0x1F4C3, "Page with Curl");
    public static readonly Emoji pageFacingUp = new(0x1F4C4, "Page Facing Up");
    public static readonly Emoji calendar = new(0x1F4C5, "Calendar");
    public static readonly Emoji tearOffCalendar = new(0x1F4C6, "Tear-Off Calendar");
    public static readonly Emoji cardIndex = new(0x1F4C7, "Card Index");
    ...
    public static readonly Emoji chartIncreasing = new(0x1F4C8, "Chart Increasing");
    public static readonly Emoji chartDecreasing = new(0x1F4C9, "Chart Decreasing");
    public static readonly Emoji barChart = new(0x1F4CA, "Bar Chart");
    public static readonly Emoji clipboard = new(0x1F4CB, "Clipboard");
    public static readonly Emoji pushpin = new(0x1F4CC, "Pushpin");
    public static readonly Emoji roundPushpin = new(0x1F4CD, "Round Pushpin");
    public static readonly Emoji paperclip = new(0x1F4CE, "Paperclip");
    public static readonly Emoji linkedPaperclips = new(0x1F587 + emojiStyle, "Linked Paperclips");
    public static readonly Emoji straightRuler = new(0x1F4CF, "Straight Ruler");
    public static readonly Emoji triangularRuler = new(0x1F4D0, "Triangular Ruler");
    public static readonly Emoji bookmarkTabs = new(0x1F4D1, "Bookmark Tabs");
    public static readonly Emoji ledger = new(0x1F4D2, "Ledger");
    public static readonly Emoji notebook = new(0x1F4D3, "Notebook");
    public static readonly Emoji notebookWithDecorativeCover = new(0x1F4D4, "Notebook with Decorative Cover");
    public static readonly Emoji closedBook = new(0x1F4D5, "Closed Book");
    public static readonly Emoji openBook = new(0x1F4D6, "Open Book");
    public static readonly Emoji greenBook = new(0x1F4D7, "Green Book");
    public static readonly Emoji blueBook = new(0x1F4D8, "Blue Book");
    public static readonly Emoji orangeBook = new(0x1F4D9, "Orange Book");
    public static readonly Emoji books = new(0x1F4DA, "Books");
    public static readonly Emoji nameBadge = new(0x1F4DB, "Name Badge");
    public static readonly Emoji scroll = new(0x1F4DC, "Scroll");
    public static readonly Emoji memo = new(0x1F4DD, "Memo");
    public static readonly Emoji scissors = new("\u2702" + emojiStyle, "Scissors");
    public static readonly Emoji envelope = new("\u2709" + emojiStyle, "Envelope");
    ...
    public static readonly Emoji rat = new(0x1F400, "Rat");
    public static readonly Emoji mouse = new(0x1F401, "Mouse");
    public static readonly Emoji ox = new(0x1F402, "Ox");
    public static readonly Emoji waterBuffalo = new(0x1F403, "Water Buffalo");
    public static readonly Emoji cow = new(0x1F404, "Cow");
    public static readonly Emoji tiger = new(0x1F405, "Tiger");
    public static readonly Emoji leopard = new(0x1F406, "Leopard");
    public static readonly Emoji rabbit = new(0x1F407, "Rabbit");
    ...
    public static readonly Emoji dragon = new(0x1F409, "Dragon");
    public static readonly Emoji crocodile = new(0x1F40A, "Crocodile");
    public static readonly Emoji whale = new(0x1F40B, "Whale");
    public static readonly Emoji snail = new(0x1F40C, "Snail");
    public static readonly Emoji snake = new(0x1F40D, "Snake");
    public static readonly Emoji horse = new(0x1F40E, "Horse");
    public static readonly Emoji ram = new(0x1F40F, "Ram");
    public static readonly Emoji goat = new(0x1F410, "Goat");
    public static readonly Emoji ewe = new(0x1F411, "Ewe");
    public static readonly Emoji monkey = new(0x1F412, "Monkey");
    public static readonly Emoji rooster = new(0x1F413, "Rooster");
    public static readonly Emoji chicken = new(0x1F414, "Chicken");
    public static readonly Emoji serviceDog = dog.Join(safetyVest, "Service Dog");
    public static readonly Emoji pig = new(0x1F416, "Pig");
    public static readonly Emoji boar = new(0x1F417, "Boar");
    public static readonly Emoji elephant = new(0x1F418, "Elephant");
    public static readonly Emoji octopus = new(0x1F419, "Octopus");
    public static readonly Emoji spiralShell = new(0x1F41A, "Spiral Shell");
    public static readonly Emoji bug = new(0x1F41B, "Bug");
    public static readonly Emoji ant = new(0x1F41C, "Ant");
    public static readonly Emoji honeybee = new(0x1F41D, "Honeybee");
    public static readonly Emoji ladyBeetle = new(0x1F41E, "Lady Beetle");
    public static readonly Emoji fish = new(0x1F41F, "Fish");
    public static readonly Emoji tropicalFish = new(0x1F420, "Tropical Fish");
    public static readonly Emoji blowfish = new(0x1F421, "Blowfish");
    public static readonly Emoji turtle = new(0x1F422, "Turtle");
    public static readonly Emoji hatchingChick = new(0x1F423, "Hatching Chick");
    public static readonly Emoji babyChick = new(0x1F424, "Baby Chick");
    public static readonly Emoji frontFacingBabyChick = new(0x1F425, "Front-Facing Baby Chick");
    public static readonly Emoji bird = new(0x1F426, "Bird");
    public static readonly Emoji penguin = new(0x1F427, "Penguin");
    public static readonly Emoji koala = new(0x1F428, "Koala");
    public static readonly Emoji poodle = new(0x1F429, "Poodle");
    public static readonly Emoji camel = new(0x1F42A, "Camel");
    public static readonly Emoji twoHumpCamel = new(0x1F42B, "Two-Hump Camel");
    public static readonly Emoji dolphin = new(0x1F42C, "Dolphin");
    public static readonly Emoji mouseFace = new(0x1F42D, "Mouse Face");
    public static readonly Emoji cowFace = new(0x1F42E, "Cow Face");
    public static readonly Emoji tigerFace = new(0x1F42F, "Tiger Face");
    public static readonly Emoji rabbitFace = new(0x1F430, "Rabbit Face");
    public static readonly Emoji catFace = new(0x1F431, "Cat Face");
    public static readonly Emoji dragonFace = new(0x1F432, "Dragon Face");
    public static readonly Emoji spoutingWhale = new(0x1F433, "Spouting Whale");
    public static readonly Emoji horseFace = new(0x1F434, "Horse Face");
    public static readonly Emoji monkeyFace = new(0x1F435, "Monkey Face");
    public static readonly Emoji dogFace = new(0x1F436, "Dog Face");
    public static readonly Emoji pigFace = new(0x1F437, "Pig Face");
    public static readonly Emoji frog = new(0x1F438, "Frog");
    public static readonly Emoji hamster = new(0x1F439, "Hamster");
    public static readonly Emoji wolf = new(0x1F43A, "Wolf");
    public static readonly Emoji polarBear = bear.Join(snowflake, "Polar Bear");
    public static readonly Emoji panda = new(0x1F43C, "Panda");
    public static readonly Emoji pigNose = new(0x1F43D, "Pig Nose");
    public static readonly Emoji pawPrints = new(0x1F43E, "Paw Prints");
    public static readonly Emoji chipmunk = new(0x1F43F + emojiStyle, "Chipmunk");
    public static readonly Emoji dove = new(0x1F54A + emojiStyle, "Dove");
    public static readonly Emoji spider = new(0x1F577 + emojiStyle, "Spider");
    public static readonly Emoji spiderWeb = new(0x1F578 + emojiStyle, "Spider Web");
    public static readonly Emoji lion = new(0x1F981, "Lion");
    public static readonly Emoji scorpion = new(0x1F982, "Scorpion");
    public static readonly Emoji turkey = new(0x1F983, "Turkey");
    public static readonly Emoji unicorn = new(0x1F984, "Unicorn");
    public static readonly Emoji eagle = new(0x1F985, "Eagle");
    public static readonly Emoji duck = new(0x1F986, "Duck");
    public static readonly Emoji bat = new(0x1F987, "Bat");
    public static readonly Emoji shark = new(0x1F988, "Shark");
    public static readonly Emoji owl = new(0x1F989, "Owl");
    public static readonly Emoji fox = new(0x1F98A, "Fox");
    public static readonly Emoji butterfly = new(0x1F98B, "Butterfly");
    public static readonly Emoji deer = new(0x1F98C, "Deer");
    public static readonly Emoji gorilla = new(0x1F98D, "Gorilla");
    public static readonly Emoji lizard = new(0x1F98E, "Lizard");
    public static readonly Emoji rhinoceros = new(0x1F98F, "Rhinoceros");
    public static readonly Emoji giraffe = new(0x1F992, "Giraffe");
    public static readonly Emoji zebra = new(0x1F993, "Zebra");
    public static readonly Emoji hedgehog = new(0x1F994, "Hedgehog");
    public static readonly Emoji sauropod = new(0x1F995, "Sauropod");
    public static readonly Emoji tRex = new(0x1F996, "T-Rex");
    public static readonly Emoji cricket = new(0x1F997, "Cricket");
    public static readonly Emoji kangaroo = new(0x1F998, "Kangaroo");
    public static readonly Emoji llama = new(0x1F999, "Llama");
    public static readonly Emoji peacock = new(0x1F99A, "Peacock");
    public static readonly Emoji hippopotamus = new(0x1F99B, "Hippopotamus");
    public static readonly Emoji parrot = new(0x1F99C, "Parrot");
    public static readonly Emoji raccoon = new(0x1F99D, "Raccoon");
    public static readonly Emoji mosquito = new(0x1F99F, "Mosquito");
    public static readonly Emoji microbe = new(0x1F9A0, "Microbe");
    public static readonly Emoji badger = new(0x1F9A1, "Badger");
    public static readonly Emoji swan = new(0x1F9A2, "Swan");
    public static readonly Emoji mammoth = new(0x1F9A3, "Mammoth");
    public static readonly Emoji dodo = new(0x1F9A4, "Dodo");
    public static readonly Emoji sloth = new(0x1F9A5, "Sloth");
    public static readonly Emoji otter = new(0x1F9A6, "Otter");
    public static readonly Emoji orangutan = new(0x1F9A7, "Orangutan");
    public static readonly Emoji skunk = new(0x1F9A8, "Skunk");
    public static readonly Emoji flamingo = new(0x1F9A9, "Flamingo");
    public static readonly Emoji beaver = new(0x1F9AB, "Beaver");
    public static readonly Emoji bison = new(0x1F9AC, "Bison");
    public static readonly Emoji seal = new(0x1F9AD, "Seal");
    public static readonly Emoji fly = new(0x1FAB0, "Fly");
    public static readonly Emoji worm = new(0x1FAB1, "Worm");
    public static readonly Emoji beetle = new(0x1FAB2, "Beetle");
    public static readonly Emoji cockroach = new(0x1FAB3, "Cockroach");
    public static readonly Emoji feather = new(0x1FAB6, "Feather");
    public static readonly Emoji guideDog = new(0x1F9AE, "Guide Dog");
