...
public static class SquareMillimeters
{
    ...
    /// </summary>
    public const double PER_SQUARE_MICROMETER = Millimeters.PER_MICROMETER * Millimeters.PER_MICROMETER;

    /// <summary>
    /// <summary>
    /// Conversion factor from square centimeters to square millimeters.
    /// </summary>
    public const double PER_SQUARE_CENTIMETER = Millimeters.PER_CENTIMETER * Millimeters.PER_CENTIMETER;

    /// <summary>
    /// Conversion factor from square inches to square millimeters.
    /// </summary>
    public const double PER_SQUARE_INCH = Millimeters.PER_INCH * Millimeters.PER_INCH;

    /// <summary>
    /// Conversion factor from square feet to square millimeters.
    /// </summary>
    public const double PER_SQUARE_FOOT = Millimeters.PER_FOOT * Millimeters.PER_FOOT;

    /// <summary>
    /// Conversion factor from square yards to square millimeters.
    /// </summary>
    public const double PER_SQUARE_YARD = Millimeters.PER_YARD * Millimeters.PER_YARD;

    /// <summary>
    /// Conversion factor from square meters to square millimeters.
    /// </summary>
    public const double PER_SQUARE_METER = Millimeters.PER_METER * Millimeters.PER_METER;

    /// <summary>
    /// Conversion factor from square rod to square millimeters.
    /// </summary>
    public const double PER_SQUARE_ROD = Millimeters.PER_ROD * Millimeters.PER_ROD;
    ...
    /// </summary>
    public const double PER_SQUARE_KILOMETER = Millimeters.PER_KILOMETER * Millimeters.PER_KILOMETER;

    /// <summary>
    /// Conversion factor from square miles to square millimeters.
    /// </summary>
    public const double PER_SQUARE_MILE = Millimeters.PER_MILE * Millimeters.PER_MILE;
    ...
    public static double SquareMicrometers(double squareMillimeters)
    {
    ...
    public static double SquareCentimeters(double squareMillimeters)
    {
    ...
    public static double SquareInches(double squareMillimeters)
    {
    ...
    public static double SquareFeet(double squareMillimeters)
    {
    ...
    public static double SquareYards(double squareMillimeters)
    {
    ...
    public static double SquareMeters(double squareMillimeters)
    {
    ...
    public static double SquareRods(double squareMillimeters)
    {
    ...
    public static double Acres(double squareMillimeters)
    {
    ...
    public static double SquareKilometers(double squareMillimeters)
    {
    ...
    public static double SquareMiles(double squareMillimeters)
    {
