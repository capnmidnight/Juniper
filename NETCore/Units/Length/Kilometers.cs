...
public static class Kilometers
{
    ...
    /// </summary>
    public const double PER_PICOMETER = 1 / Units.Picometers.PER_KILOMETER;

    /// <summary>
    /// Conversion factor from nanometers to inches.
    /// </summary>
    public const double PER_NANOMETER = 1 / Units.Nanometers.PER_KILOMETER;
    ...
    /// <summary>
    /// Convert from kilometers to picometers.
    /// </summary>
    /// <param name="kilometers">The number of kilometers</param>
    /// <returns>The number of picometers</returns>
    public static double Picometers(double kilometers)
    {
        return kilometers * Units.Picometers.PER_KILOMETER;
    }
    ...
    public static double Nanometers(double kilometers)
    {
        return kilometers * Units.Nanometers.PER_KILOMETER;
    }
    ...
    {
        return kilometers * Units.Micrometers.PER_KILOMETER;
    }
