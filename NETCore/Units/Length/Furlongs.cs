...
public static class Furlongs
{
    ...
    /// </summary>
    public const double PER_PICOMETER = 1 / Units.Picometers.PER_FURLONG;

    /// <summary>
    /// Conversion factor from nanometers to inches.
    /// </summary>
    public const double PER_NANOMETER = 1 / Units.Nanometers.PER_FURLONG;
    ...
    /// <summary>
    /// Convert from furlongs to picometers.
    /// </summary>
    /// <param name="furlongs">The number of furlongs</param>
    /// <returns>The number of picometers</returns>
    public static double Picometers(double furlongs)
    {
        return furlongs * Units.Picometers.PER_FURLONG;
    }

    /// <summary>
    /// Convert from furlongs to nanometers.
    /// </summary>
    /// <param name="furlongs">The number of furlongs</param>
    /// <returns>The number of nanometers</returns>
    public static double Nanometers(double furlongs)
    {
        return furlongs * Units.Nanometers.PER_FURLONG;
    }
