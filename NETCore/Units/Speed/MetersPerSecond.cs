...
public static class MetersPerSecond
{
    ...
    /// </summary>
    public const double PER_MILE_PER_HOUR = Units.Meters.PER_MILE / Units.Seconds.PER_HOUR;

    /// <summary>
    /// Conversion factor from kilometers per hour to meters per second.
    /// </summary>
    public const double PER_KILOMETER_PER_HOUR = Units.Meters.PER_KILOMETER / Units.Seconds.PER_HOUR;

    /// <summary>
    /// Conversion factor from feet per second to meters per second.
    /// </summary>
    public const double PER_FOOT_PER_SECOND = Units.Meters.PER_FOOT;

    /// <summary>
    /// Conversion factor from millimeters per second to meters per second.
    /// </summary>
    public const double PER_MILLIMETER_PER_SECOND = Units.Meters.PER_MILLIMETER;
    ...
    public static double MilesPerHour(double mps)
    {
    ...
    public static double KilometersPerHour(double mps)
    {
    ...
    public static double FeetPerSecond(double mps)
    {
    ...
    public static double MillimetersPerSecond(double mps)
    {
