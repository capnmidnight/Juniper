...
public class JuniperAssetHelper
{
    ...
    public class JSHelper
    {
        ...
        {
            XLSX = dir.Touch("xlsx-0.20.1.tgz");
        }
    ...
    public class AudiosHelper
    {
        ...
        {
            UIDraggedAudio = dir.Touch("basic_dragged.mp3");
            UIEnterAudio = dir.Touch("basic_enter.mp3");
            UIErrorAudio = dir.Touch("basic_error.mp3");
            UIExitAudio = dir.Touch("basic_exit.mp3");
            DoorOpenAudio = dir.Touch("door_open.mp3");
            DoorCloseAudio = dir.Touch("door_close.mp3");
            FootStepsAudioFast = dir.Touch("footsteps_fast.mp3");
            FootStepsAudioSlow = dir.Touch("footsteps_slow.mp3");
            ForestAudio = dir.Touch("forest.mp3");
            ButtonPressAudio = dir.Touch("vintage_radio_button_pressed.mp3");
            StarTrek = new StarTrekAudiosHelper(dir.CD("Star Trek"));
        }

        public FileInfo ForestAudio { get; }
        public FileInfo FootStepsAudioFast { get; }
        public FileInfo FootStepsAudioSlow { get; }
