...
They have until {expiry} to set their password.");
    ...
    public static async Task<UserT?> GetTypedUser<UserT>(this UserManager<UserT> userManager, ClaimsPrincipal userClaim)
        where UserT : class
    {
        ...
        var users = await userManager.GetUsersForClaimAsync(sidClaim);
