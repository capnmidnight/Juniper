...
public static class Inches
{
    ...
    /// </summary>
    public const double PER_PICOMETER = 1 / Units.Picometers.PER_INCH;

    /// <summary>
    /// Conversion factor from nanometers to inches.
    /// </summary>
    public const double PER_NANOMETER = 1 / Units.Nanometers.PER_INCH;
    ...
    /// <summary>
    /// Convert from inches to picometers.
    /// </summary>
    /// <param name="inches">The number of inches</param>
    /// <returns>The number of picometers</returns>
    public static double Picometers(double inches)
    {
        return inches * Units.Picometers.PER_INCH;
    }
    ...
    public static double Nanometers(double inches)
    {
        return inches * Units.Nanometers.PER_INCH;
    }
