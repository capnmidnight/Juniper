...
public static class Feet
{
    ...
    /// </summary>
    public const double PER_PICOMETER = 1 / Units.Picometers.PER_FOOT;

    /// <summary>
    /// Conversion factor from nanometers to inches.
    /// </summary>
    public const double PER_NANOMETER = 1 / Units.Nanometers.PER_FOOT;
    ...
    /// <summary>
    /// Convert from feet to picometers.
    /// </summary>
    /// <param name="feet">The number of feet</param>
    /// <returns>The number of picometers</returns>
    public static double Picometers(double feet)
    {
        return feet * Units.Picometers.PER_FOOT;
    }

    /// <summary>
    /// Convert from feet to nanometers.
    /// </summary>
    /// <param name="feet">The number of feet</param>
    /// <returns>The number of nanometers</returns>
    public static double Nanometers(double feet)
    {
        return feet * Units.Nanometers.PER_FOOT;
    }
