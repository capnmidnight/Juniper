...
public class ShellCommand : AbstractShellCommand
{
    ...
    private static IEnumerable<string> FindCommandPaths(string? command)
    {
        ...
        var dirs = DirectoryInfoExt.LazyRecurse(Environment.CurrentDirectory)
            .Union(PATH.Split(Path.PathSeparator))
