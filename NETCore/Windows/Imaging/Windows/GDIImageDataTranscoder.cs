...
public class GDIImageDataTranscoder : IImageCodec<Image, ImageData>
{
    public ImageData Translate(Image image, IProgress? prog = null)
    {
        if (image is null)
        {
    ...
    public Image Translate(ImageData image, IProgress? prog = null)
    {
        if (image is null)
        {
            throw new ArgumentNullException(nameof(image));
