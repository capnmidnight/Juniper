...
public class TextToSpeechStreamClient : VoicesClient
{
    ...
    public TextToSpeechStreamClient(HttpClient http, string azureRegion, string azureSubscriptionKey, string azureResourceName, IJsonDecoder<Voice[]> voiceListDecoder, CachingStrategy? cache = null)
