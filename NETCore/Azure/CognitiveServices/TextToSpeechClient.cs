...
public class TextToSpeechClient : TextToSpeechStreamClient
{
    ...
    public TextToSpeechClient(HttpClient http, string azureRegion, string azureSubscriptionKey, string azureResourceName, IJsonDecoder<Voice[]> voiceListDecoder, IAudioDecoder audioDecoder, CachingStrategy? cache = null)
    ...
    public Task<AudioData?> GetDecodedAudioAsync(AudioFormat outputFormat, string text, Voice voice, float rateChange, float pitchChange)
    {
        ...
        return GetDecodedAudioAsync(outputFormat, text, voice.ShortName ?? throw new ArgumentNullException("voice.ShortName"), rateChange, pitchChange);
    }
    ...
    public Task<Stream> GetWaveAudioAsync(AudioFormat outputFormat, string text, Voice voice, float rateChange, float pitchChange)
    {
        ...
        return GetWaveAudioAsync(outputFormat, text, voice.ShortName ?? throw new ArgumentNullException("voice.ShortName"), rateChange, pitchChange);
    }
