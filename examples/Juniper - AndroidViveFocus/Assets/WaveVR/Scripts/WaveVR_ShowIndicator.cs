...
public class WaveVR_ShowIndicator : MonoBehaviour {
    ...
    public void createIndicator() {
        ...
        PrintInfoLog("showIndicatorAngle: " + showIndicatorAngle + ", hideIndicatorByRoll: " + hideIndicatorByRoll);
        ...
        foreach (ButtonIndication bi in buttonIndicationList)
        {
            ...
            switch(bi.keyType)
            {
                case ButtonIndication.KeyIndicator.AppButton:
                    ...
                    break;
                case ButtonIndication.KeyIndicator.DigitalTriggerKey:
                    partName = "_[CM]_DigiTriggerKey";
                    partName1 = "__CM__DigiTriggerKey";
            ...
            {
                PrintInfoLog("Neither " + partName + " or " + partName1 + " is not in the model!");
            }
        }
