...
public class WaveVR_Render : MonoBehaviour
{
    ...
    private static bool isInitializeGraphic = false;
    ...
    public WaveVR_Utils.WVR_PerfLevel cpuPerfLevel;
    public WaveVR_Utils.WVR_PerfLevel gpuPerfLevel;
    /// <summary>
    ...
    private void RenderEye(Camera camera, WVR_Eye eye)
    {
        ...
        Log.gpl.d(LOG_TAG, (eye == WVR_Eye.WVR_Eye_Left) ? "Render_WVR_Eye_Left" : "Render_WVR_Eye_Right");
